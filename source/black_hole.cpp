...
// DEBUG: Verify scaling for shader
void printScaling() {
    cout << "[INFO] Black Hole Mass: " << SagA.mass << endl;
    cout << "[INFO] Schwarzschild Radius (Rs): " << SagA.r_s << endl;
    cout << "[INFO] Shader Normalization Scale (Rs/2): " << SagA.r_s / 2.0 << endl;
}
struct ObjectData {
...
struct Engine {
    ...
    Engine() {
        ...
        glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_NORMAL); // Ensure mouse is visible
